...
def DecryptSignatureNew(s, playerUrl):
    ...
    try:
        ...
        #print str(e)
        xbmc.log('Super Favourites yt.py: Failed to decode playerData', xbmc.LOGWARNING)
        return ''
    ...
    if match:
        ...
        xbmc.log('Super Favourites yt.py: Failed to get main signature function name', xbmc.LOGWARNING)
        return ''
    ...
    try:
        ...
        xbmc.log('Super Favourites yt.py: Failed to obtain decryptSignature code', xbmc.LOGWARNING)
        return ''
    ...
    try:
        ...
        xbmc.log('Super Favourites yt.py: decryptSignature code failed to execute correctly', xbmc.LOGWARNING)
        return ''
...
def _getfullAlgoCode(mainFunName, recDepth=0):
    ...
    if MAX_REC_DEPTH <= recDepth:
        xbmc.log('Super Favourites yt.py: _getfullAlgoCode: Maximum recursion depth exceeded', xbmc.LOGWARNING)
        return 
